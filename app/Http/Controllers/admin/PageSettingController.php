...
class PageSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        'Slider Images',
        'Info Tabs',
        'Dashboard'];  // Add any group names you want to include

        // Fetch settings where the group is part of the specified groups
        $settings = Setting::whereIn('group', $pageGroups)->get();
        ...
        return view('admin.content.page-settings.index', compact('groups', 'groupedSettings'));
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.page-setting.index')->with('success', 'Setting is stored');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function update(Request $request)
    {
        try {
            ...
            DB::commit();
            return redirect()->route('admin.page-setting.index')->with('success', 'Settings updated successfully.');
        } catch (\Exception $e) {
            DB::rollBack();
            return back()->with('error', 'Something went wrong. ' . $e->getMessage());
        }
