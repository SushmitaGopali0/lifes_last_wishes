                        ...
                        <form class="forms-sample" method="POST" action="{{ route('admin.newsletter.update', $newsletter) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail3" placeholder="First Name"
                                    name="fname" value="{{ $newsletter->firstname }}">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Last Name"
                                    name="lname" value="{{ $newsletter->lastname }}">
                            </div>
                            <div class="form-group">
                                ...
                                <div style="display: flex; gap: 15px; align-items: center;">
                                    <div class="form-check form-check-success">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="confirmed" id="optionsRadios2" value="yes" {{ $newsletter->confirmed == 'yes' ? 'checked' : ''}}>
                                            Yes
                                        </label>
                                    </div>
                                    <div class="form-check form-check-danger">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="confirmed" id="optionsRadios1" value="no" {{ $newsletter->confirmed == 'no' ? 'checked' : ''}}>
                                            No
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div style="display: flex; gap: 15px; align-items: center;">
                                    <div class="form-check form-check-success">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="subscribed" id="optionsRadios2" value="yes" {{ $newsletter->subscribed == 'yes' ? 'checked' : ''}}>
                                            Yes
                                        </label>
                                    </div>
                                    <div class="form-check form-check-danger">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="subscribed" id="optionsRadios1" value="no" {{ $newsletter->subscribed == 'no' ? 'checked' : ''}}>
                                            No
                                        </label>
                                    </div>
                                </div>
