                        ...
                        <form class="forms-sample" method="POST" action="{{ route('admin.newsletter.store') }}">
                                ...
                                <div style="display: flex; gap: 15px; align-items: center;">
                                    <div class="form-check form-check-success">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="confirmed" id="optionsRadios2" value="yes" checked="">
                                            Yes
                                        </label>
                                    </div>
                                    <div class="form-check form-check-danger">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="confirmed" id="optionsRadios1" value="no">
                                            No
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div style="display: flex; gap: 15px; align-items: center;">
                                    <div class="form-check form-check-success">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="subscribed" id="optionsRadios2" value="yes" checked="">
                                            Yes
                                        </label>
                                    </div>
                                    <div class="form-check form-check-danger">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="subscribed" id="optionsRadios1" value="no">
                                            No
                                        </label>
                                    </div>
                                </div>
