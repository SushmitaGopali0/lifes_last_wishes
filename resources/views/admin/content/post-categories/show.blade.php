    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Post Category View Page </h4>
                        <form class="forms-sample" method="POST" action="{{ route('admin.post-category.store') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Order"
                                    name="order" value="{{ old('order', $postCategory->order) }}" disabled>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail3">Name</label>
                                <input type="text" class="form-control" id="exampleInputEmail3"
                                    placeholder="Name of post category" name="name" value="{{ old('name', $postCategory->name) }}" disabled>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail3">Slug</label>
                                <input type="text" class="form-control" id="exampleInputEmail3"
                                    placeholder="Slug of post category" name="slug" value="{{ old('slug', $postCategory->slug) }}" disabled>
                            </div>
                        </form>
                    </div>
                </div>
