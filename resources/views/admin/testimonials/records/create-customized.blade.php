    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title"> Customized Testimonial Store form </h4>
                        <form class="forms-sample" method="POST" action="{{ route('admin.customized-testimonial.store') }}">
                            @csrf
                            <div class="form-group">
                                <label for="exampleInputEmail3">Email</label>
                                <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Email"
                                    name="cemail" value="{{ old('cemail') }}">
                            </div>
                            <div class="form-group">
