                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('admin.testimonial.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="exampleTextarea1" cols="30" rows="10" name="message" placeholder="Testimonial message"></textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-danger">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="status"
                                            id="optionsRadios2" value="0" checked="">
                                        Pending
