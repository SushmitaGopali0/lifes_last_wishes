    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Coupon Store form </h4>
                        <form class="forms-sample" method="POST" action="{{ route('admin.coupon.store') }}">
                            @csrf
                            <div class="form-group">
                                <label for="exampleInputEmail3">Code</label>
                                <input type="text" class="form-control" id="exampleInputEmail3"
                                    placeholder="Code for the Coupon" name="code" value="{{ old('code', $code) }}">
                            </div>
                            <div class="form-group">
